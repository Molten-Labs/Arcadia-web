              ...
              <TableBody>
                {TX_HISTORY.map((row, i) => (
                  <TableRow key={i} className="group">
                    ...
                    <TableCell
                      className={
                        row.status === "Confirmed" || row.status === "Settled" ? "text-success" : "text-tier-advanced"
                      }
                    >
                      {row.status}
                    </TableCell>
                    <TableCell className={row.sig !== "—" ? "text-acid" : "text-faint"}>{row.sig}</TableCell>
                    <TableCell className="text-right tabular-nums text-faint">{row.ts}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
